...
class ShapelySupportTest(unittest.TestCase):
    ...
    def test_as_geojson_geometry_invalid(self):
        ...
        self.assertRaises(ValueError, as_geojson_geometry, dict(self.feature['geometry'], type='Foo'))
        self.assertRaises(ValueError, as_geojson_geometry, dict(self.feature['geometry'], coordinates=1))
        self.assertRaises(ValueError, as_geojson_geometry, {
            "type": "FeatureCollection",
