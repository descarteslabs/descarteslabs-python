...
class TestRequestsWithRetry(unittest.TestCase):
    ...
    def test_headers_set_on_session(self):
        ...
        for method in ['GET', 'POST', 'PATCH', 'PUT', 'DELETE', 'OPTIONS', 'HEAD']:
            responses.add_callback(method, "https://platform.descarteslabs.com", callback=request_callback)
            self.assertEqual(getattr(client, method.lower())("https://platform.descarteslabs.com").status_code, 200)
