...
from descarteslabs.common.proto.destinations import (
    destinations_pb2 as descarteslabs_dot_common_dot_proto_dot_destinations_dot_destinations__pb2,
)
from descarteslabs.common.proto.formats import (
    formats_pb2 as descarteslabs_dot_common_dot_proto_dot_formats_dot_formats__pb2,
)
from descarteslabs.common.proto.types import (
    types_pb2 as descarteslabs_dot_common_dot_proto_dot_types_dot_types__pb2,
)
from descarteslabs.common.proto.typespec import (
    typespec_pb2 as descarteslabs_dot_common_dot_proto_dot_typespec_dot_typespec__pb2,
)
from descarteslabs.common.proto.errors import (
    errors_pb2 as descarteslabs_dot_common_dot_proto_dot_errors_dot_errors__pb2,
)
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        descarteslabs_dot_common_dot_proto_dot_destinations_dot_destinations__pb2.DESCRIPTOR,
        descarteslabs_dot_common_dot_proto_dot_formats_dot_formats__pb2.DESCRIPTOR,
        descarteslabs_dot_common_dot_proto_dot_types_dot_types__pb2.DESCRIPTOR,
        descarteslabs_dot_common_dot_proto_dot_typespec_dot_typespec__pb2.DESCRIPTOR,
        descarteslabs_dot_common_dot_proto_dot_errors_dot_errors__pb2.DESCRIPTOR,
    ],
    public_dependencies=[
        descarteslabs_dot_common_dot_proto_dot_errors_dot_errors__pb2.DESCRIPTOR,
    ],
...
_JOB_STAGE = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(
            name="PREPARING", index=2, number=2, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="RUNNING", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SAVING", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="FAILED", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="SUCCEEDED", index=6, number=6, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
...
_JOB_TASKSPROGRESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="waiting",
            full_name="descarteslabs.workflows.Job.TasksProgress.waiting",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="ready",
            full_name="descarteslabs.workflows.Job.TasksProgress.ready",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="running",
            full_name="descarteslabs.workflows.Job.TasksProgress.running",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="finished",
            full_name="descarteslabs.workflows.Job.TasksProgress.finished",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_JOB_ERROR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="code",
            full_name="descarteslabs.workflows.Job.Error.code",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="descarteslabs.workflows.Job.Error.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_JOB_STATE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="stage",
            full_name="descarteslabs.workflows.Job.State.stage",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="tasks_progress",
            full_name="descarteslabs.workflows.Job.State.tasks_progress",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="tasksProgress",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="error",
            full_name="descarteslabs.workflows.Job.State.error",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="descarteslabs.workflows.Job.State.timestamp",
            index=3,
            number=4,
            type=3,
            cpp_type=2,
...
_JOB = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="descarteslabs.workflows.Job.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="serialized_graft",
            full_name="descarteslabs.workflows.Job.serialized_graft",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
            ...
            extension_scope=None,
            serialized_options=None,
            json_name="serializedGraft",
            file=DESCRIPTOR,
        ),
        _descriptor.FieldDescriptor(
            name="typespec",
            full_name="descarteslabs.workflows.Job.typespec",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="descarteslabs.workflows.Job.parameters",
            index=3,
            number=4,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="no_cache",
            full_name="descarteslabs.workflows.Job.no_cache",
            index=4,
            number=5,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="channel",
            full_name="descarteslabs.workflows.Job.channel",
            index=5,
            number=6,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="client_version",
            full_name="descarteslabs.workflows.Job.client_version",
            index=6,
            number=14,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="descarteslabs.workflows.Job.timestamp",
            index=7,
            number=7,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="user",
            full_name="descarteslabs.workflows.Job.user",
            index=8,
            number=8,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="org",
            full_name="descarteslabs.workflows.Job.org",
            index=9,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="descarteslabs.workflows.Job.type",
            index=11,
            number=11,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="format",
            full_name="descarteslabs.workflows.Job.format",
            index=12,
            number=12,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="destination",
            full_name="descarteslabs.workflows.Job.destination",
            index=13,
            number=13,
            type=11,
            cpp_type=10,
...
_CREATEJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="serialized_graft",
            full_name="descarteslabs.workflows.CreateJobRequest.serialized_graft",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="typespec",
            full_name="descarteslabs.workflows.CreateJobRequest.typespec",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="parameters",
            full_name="descarteslabs.workflows.CreateJobRequest.parameters",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="no_cache",
            full_name="descarteslabs.workflows.CreateJobRequest.no_cache",
            index=3,
            number=4,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="channel",
            full_name="descarteslabs.workflows.CreateJobRequest.channel",
            index=4,
            number=5,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="client_version",
            full_name="descarteslabs.workflows.CreateJobRequest.client_version",
            index=5,
            number=9,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="type",
            full_name="descarteslabs.workflows.CreateJobRequest.type",
            index=6,
            number=6,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="format",
            full_name="descarteslabs.workflows.CreateJobRequest.format",
            index=7,
            number=7,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="destination",
            full_name="descarteslabs.workflows.CreateJobRequest.destination",
            index=8,
            number=8,
            type=11,
            cpp_type=10,
...
_GETJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="descarteslabs.workflows.GetJobRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_CANCELJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="descarteslabs.workflows.CancelJobRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_WATCHJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="id",
            full_name="descarteslabs.workflows.WatchJobRequest.id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_LISTJOBSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="start_datetime",
            full_name="descarteslabs.workflows.ListJobsRequest.start_datetime",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="end_datetime",
            full_name="descarteslabs.workflows.ListJobsRequest.end_datetime",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_JOB_TASKSPROGRESS.fields_by_name[
    "waiting"
...
_JOB_ERROR.fields_by_name[
    "code"
].enum_type = descarteslabs_dot_common_dot_proto_dot_errors_dot_errors__pb2._ERRORCODE
...
_JOB.fields_by_name[
    ...
    descarteslabs_dot_common_dot_proto_dot_typespec_dot_typespec__pb2._TYPESPEC
)
_JOB.fields_by_name["state"].message_type = _JOB_STATE
_JOB.fields_by_name[
    "type"
].enum_type = descarteslabs_dot_common_dot_proto_dot_types_dot_types__pb2._RESULTTYPE
_JOB.fields_by_name[
    "format"
].message_type = descarteslabs_dot_common_dot_proto_dot_formats_dot_formats__pb2._FORMAT
_JOB.fields_by_name[
    "destination"
].message_type = (
    descarteslabs_dot_common_dot_proto_dot_destinations_dot_destinations__pb2._DESTINATION
)
...
Job = _reflection.GeneratedProtocolMessageType(
    ...
    (_message.Message,),
    {
        "TasksProgress": _reflection.GeneratedProtocolMessageType(
            "TasksProgress",
            (_message.Message,),
            {
...
WatchJobRequest = _reflection.GeneratedProtocolMessageType(
    "WatchJobRequest",
    (_message.Message,),
    {
