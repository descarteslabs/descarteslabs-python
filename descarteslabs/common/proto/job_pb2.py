...
_JOBSTAGE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="STAGE_UNKNOWN", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STAGE_PENDING", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STAGE_PREPARING",
            index=2,
            number=2,
            serialized_options=None,
            type=None,
        ...
        _descriptor.EnumValueDescriptor(
            name="STAGE_RUNNING", index=3, number=3, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STAGE_SAVING", index=4, number=4, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STAGE_DONE", index=5, number=5, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="STAGE_EXPIRED", index=6, number=6, serialized_options=None, type=None
        ),
    ],
    containing_type=None,
    serialized_options=None,
...
_JOBERROR = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="code",
            full_name="descarteslabs.workflows.JobError.code",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="message",
            full_name="descarteslabs.workflows.JobError.message",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_JOBPROGRESS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="waiting",
            full_name="descarteslabs.workflows.JobProgress.waiting",
            index=0,
            number=1,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="ready",
            full_name="descarteslabs.workflows.JobProgress.ready",
            index=1,
            number=2,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="running",
            full_name="descarteslabs.workflows.JobProgress.running",
            index=2,
            number=3,
            type=13,
            cpp_type=3,
        ...
        _descriptor.FieldDescriptor(
            name="finished",
            full_name="descarteslabs.workflows.JobProgress.finished",
            index=3,
            number=4,
            type=13,
            cpp_type=3,
...
_ENTRY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="timestamp",
            full_name="descarteslabs.workflows.Entry.timestamp",
            index=0,
            number=1,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="stage",
            full_name="descarteslabs.workflows.Entry.stage",
            index=1,
            number=2,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="error",
            full_name="descarteslabs.workflows.Entry.error",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="progress",
            full_name="descarteslabs.workflows.Entry.progress",
            index=3,
            number=4,
            type=11,
            cpp_type=10,
...
_JOB = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="descarteslabs.workflows.Job.created_timestamp",
            index=1,
            number=2,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="descarteslabs.workflows.Job.updated_timestamp",
            index=2,
            number=3,
            type=3,
            cpp_type=2,
        ...
        _descriptor.FieldDescriptor(
            name="status",
            full_name="descarteslabs.workflows.Job.status",
            index=4,
            number=5,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="terminated",
            full_name="descarteslabs.workflows.Job.terminated",
            index=6,
            number=7,
            type=8,
            cpp_type=7,
        ...
        _descriptor.FieldDescriptor(
            name="workflow_id",
            full_name="descarteslabs.workflows.Job.workflow_id",
            index=10,
            number=18,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="log",
            full_name="descarteslabs.workflows.Job.log",
            index=11,
            number=19,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="progress",
            full_name="descarteslabs.workflows.Job.progress",
            index=12,
            number=20,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="serialized_typespec",
            full_name="descarteslabs.workflows.Job.serialized_typespec",
            index=14,
            number=22,
            type=9,
            cpp_type=9,
...
_CREATEJOBREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="workflow_id",
            full_name="descarteslabs.workflows.CreateJobRequest.workflow_id",
            index=1,
            number=3,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="serialized_typespec",
            full_name="descarteslabs.workflows.CreateJobRequest.serialized_typespec",
            index=4,
            number=6,
            type=9,
            cpp_type=9,
...
_LISTJOBSREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="workflow_id",
            full_name="descarteslabs.workflows.ListJobsRequest.workflow_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
JobError = _reflection.GeneratedProtocolMessageType(
    "JobError",
    (_message.Message,),
    dict(
...
JobProgress = _reflection.GeneratedProtocolMessageType(
    "JobProgress",
    (_message.Message,),
    dict(
