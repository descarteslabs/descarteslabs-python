...
_XYZ = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='url_template', full_name='descarteslabs.workflows.XYZ.url_template', index=11,
