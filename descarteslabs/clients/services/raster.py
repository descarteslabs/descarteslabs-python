...
from ..addons import ThirdParty, blosc, numpy as np
from ..utilities import as_json_string, read_blosc_array
...
class Raster(Service):
    ...
    def __init__(self, url=None, token=None, auth=descartes_auth):
