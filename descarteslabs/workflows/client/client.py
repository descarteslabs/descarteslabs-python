...
class Client(GrpcClient):
    ...
    def _populate_api(self):
        ...
        self._add_api("Workflow", "CreateWorkflow", self._default_retry)
        self._add_api("Workflow", "GetWorkflow", self._default_retry)
        self._add_api("Workflow", "ListWorkflows", self._default_retry)
        self._add_api("Workflow", "UpdateWorkflow", self._default_retry)
