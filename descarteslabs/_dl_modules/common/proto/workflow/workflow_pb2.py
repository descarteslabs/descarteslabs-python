...
_UPSERTWORKFLOWREQUEST_LABELSENTRY = _UPSERTWORKFLOWREQUEST.nested_types_by_name[
    "LabelsEntry"
]
...
WmtsUrlTemplateResponse = _reflection.GeneratedProtocolMessageType(
    "WmtsUrlTemplateResponse",
    (_message.Message,),
    {
